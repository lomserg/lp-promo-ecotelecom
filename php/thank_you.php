...
<body>
    ...
    <div class="main-content">
        ...
        <p class="main-content__body" data-lead-id="main-content-body">
            Наш менеджер свяжется с вами в течение часа (с 9:00-21:00). Если вы
            отправили запрос после 21:00, менеджер свяжется с вами утром до 11-00.
        </p>
    </div>

    <footer class="site-footer" id="footer">
        <p class="site-footer__fineprint" id="fineprint">
            © Экотелеком <?php echo date("Y") ?>
        </p>
    </footer>
