...
<body>
    ...
    <section class="hero__bg">
        <header class="header">
            <div class="header-content">
                ...
                <div class="whatsapp">
                    <a id="whatsapp-link" href="https://api.whatsapp.com/send/?phone=79776340477" target="">
                        <img class="" alt=""
                            src="https://i.1.creatium.io/84/76/1c/1fb6a2b7eec23669fcb0131c6057dc770c/whatsapp_icon_png_1.png" /></a>
                </div>
                <div class="phone text-dark">
                    <a class="phoneid" href="tel:+74958017799" style="text-decoration: none; color: inherit">
                        +7 495 801-77-99
                    </a>
                </div>
            </div>
                        ...
                        <div class="tarif-slider-description" data-package="5b504edcb2de77e82f591f1a">
                            ...
                            <div class="tarif-param">
                                ...
                                <div class="tarif channels-item" data-package="5b504edcb2de77e82f591f1a">
                                    <a class="channels_link link trigger" href="#channels">95 ТВ-каналов</a>
                                </div>
                                <p class="tarif-movie">
        ...
        <div class="contact-box">
            <form action="./php/telegram2.php" method="post" id="form1" name="call-form"
                ...
                <input type="hidden" name="utm_source"
                    value="<?= isset($_GET['utm_source']) ? htmlspecialchars($_GET['utm_source']) : '' ?>" />
                <input type="hidden" name="utm_medium"
                    value="<?= isset($_GET['utm_medium']) ? htmlspecialchars($_GET['utm_medium']) : '' ?>" />
                <input type="hidden" name="utm_campaign"
                    value="<?= isset($_GET['utm_campaign']) ? htmlspecialchars($_GET['utm_campaign']) : '' ?>" />
                <input type="hidden" name="utm_content"
                    value="<?= isset($_GET['utm_content']) ? htmlspecialchars($_GET['utm_content']) : '' ?>" />
                <input type="hidden" name="utm_term"
                    value="<?= isset($_GET['utm_term']) ? htmlspecialchars($_GET['utm_term']) : '' ?>" />
    ...
    <footer class="footer">
        ...
        <ul class="social-list">
            ...
            <li class="social-item">
                <a href="https://t.me/ecotelecom_msk" class="social-link"><i class="fab fa-telegram"></i></a>
            </li>
