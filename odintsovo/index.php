...
<section class="tarifs__section" id="tarifs__section">
    <h1 id="tarif_block" class="section-title fs-600">Тарифы на интернет в Одинцово</h1>
    <p class="t-center fs-300">
        Подключите быстрый и стабильный интернет в Одинцово от надежного провайдера.
        Тарифы подойдут для работы, игр и просмотра ТВ.
    </p>
        ...
        <div class="feature-blocks flow">
            <div class="feature grid-container-advantages bg-blue text-white">
                ...
                <div class="feature-advantage-item">
                    ...
                    <div class="adv-content">
                        <div class="feature-title fs-400 text-white ff-main fw-bold">
                            Стабильный интернет в Одинцово </div>
                        <div class="feature-description fs-300">
...
<section class="form container">
    <h2 style="text-align: center" class="fs-600"> Оставьте заявку на подключение интернета в Одинцово — мы свяжемся с
        вами и подберем лучший тариф.</h2>
