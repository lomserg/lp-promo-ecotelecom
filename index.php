...
<body>
    ...
    <noscript>
        <div>
            <img src="https://mc.yandex.ru/watch/49966909" style="position: absolute; left: -9999px" alt="" />
        </div>
    </noscript>
    <!-- /Yandex.Metrika counter -->
    ...
    <section class="hero__bg">
        ...
        <div class="hero__bg-container container">
            <div class="hero-txt-cta">
                <h1 class="hero__bg-title">3 МЕСЯЦА</h1>
                <h3 class="hero__bg-bigtitle">БЕСПЛАТНО</h3>
                <p class="hero__title--sub">БОЛЬШЕ ВЫГОДЫ ЭТОЙ ВЕСНОЙ</p>
        ...
        <!-- <div class="hero__bg-container container">
        <h1 class="hero__bg-title">ИНТЕРНЕТ ДОМАШНИЙ</h1>
        <h3 class="hero__bg-title">скорости дикие</h3>
        <h3 class="hero__bg-title">цены ручные</h3>
        ...
        <div class="info-blocks">
          ...
          <div class="info-block">
            <div class="info-block-feature fs-300 uppercase fw-bold">315</div>
            <div class="info-block-text">каналов</div>
          </div>
          <div class="info-block img">
            <img src="./img/logo_Premier_w.png" alt="" />
          ...
          <div class="info-block">
            <div class="info-block-feature fs-300 uppercase fw-bold">600</div>
            <div class="info-block-text">₽/мес</div>
          </div>
        </div>
      </div> -->
    ...
    <section class="faq container">
        ...
        <div class="accordion">
            ...
            <div class="accordion-item">
                <div class="accordion-item-header fs-400">
                    Условия подключения по акции «3 месяца в подарок»
                </div>
                <div class="accordion-item-body">
                    <div class="accordion-item-body-content">
                        <ul class="flow">
                            <li>
                                Заявки на подключение по акции принимаются до 13.06.25,
                                подключение проводится до 20.06.25 включительно.
                            </li>
                            ...
                            <li>
                                ...
                                ЖК «Новая Звезда» и ЖК «Гарден Парк» (Москва, Коммунарка), ЖК
                                «Кленовые Аллеи» и ЖК «Новые Ватутинки» (Москва, Десёновское),
                                ЖК «Цветочные поляны» (Москва, Филимонковское), ЖК «Позитив»
                                (Москва, Московский), ЖК «Новоград Павлино» (Балашиха), ЖК
                                «Весенний» (Подольск), ул. Военный городок 42 (Одинцово), а
                                также ЖК «Кутузовская Ривьера», ЖК «Золотые Ключи 2», ЖК
                                «Барклая 7», ЖК «Well House на Ленинском» и ЖК «Корона»
                                (Москва).
                            </li>

                            <li>В акции участвуют тарифы «МЕГА» и «УЛЬТРА+КИНО».</li>
                            <li>
                                Цены на первые 3 месяца с момента подключения с учетом скидки:
                                «МЕГА» — 0 руб./мес., «УЛЬТРА+КИНО» — 0 руб./мес. С 4 месяца
                                услуги предоставляются на условиях действующих тарифных
                                планов.
                            </li>
                            <li>
                                При подключении по акции на лицевой счет необходимо внести
                                авансовый платеж в размере не менее 1500 рублей.
                            </li>
                        </ul>
                    </div>
                </div>
    ...
    <section class="form container">
        ...
        <div class="contact-box">
            ...
            <form action="./php/form1.php" method="post" id="form1" name="call-form">
                ...
                <label class="fs-200" for="adr11">Адрес</label>
                <input type="text" class="field" name="address" id="adr11" required />
                <button type="submit bg-violet" class="button-63" style="width: 80%; margin-left: 2rem"
                    name="call-submit"
                    onsubmit="if (validateForm(event, this.form)) { this.disabled=true; this.value='Sending, please wait...'; ym(49966909, 'reachGoal', 'form-submit'); } return false;">
                    Отправить
                </button>
    ...
    (function() {
        ...
        function zy() {
            ...
            d.cookie =
                "JivoSiteLoaded=1;path=/;expires=" + cookie_date.toGMTString();
        }
    ...
    <!-- Google tag (gtag.js) -->
    <script async src="https://www.googletagmanager.com/gtag/js?id=G-J64FEQC199"></script>
    <script>
