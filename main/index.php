    ...
    <section class="hero__bg">
      ...
      <div class="hero__bg-container container">
        <div class="hero-txt-cta">
          <h1 class="hero__bg-bigtitle">ИНТЕРНЕТ</h1>
          <h3 class="hero__bg-title">БЕЗ ФОКУСОВ</h3>
          ...
          <div class="info-blocks">
            ...
            <div class="info-block">
              <div class="info-block-feature fs-300 uppercase fw-bold">555</div>
        ...
        <div class="swiper-wrapper">
          ...
          <div class="swiper-slide tarif-option">
            <div class="tarif-slider-description">
              ...
              <p class="tarif-price">
                555 <span style="font-size: 0.75rem">₽/мес</span>
              </p>
          ...
          <div class="swiper-wrapper">
            ...
            <div class="swiper-slide tarif-option">
              <div class="tarif-slider-description">
                ...
                <p class="tarif-price">
                  666<span style="font-size: 0.75rem">₽/мес</span>
                </p>
                <div class="tarif-param">
                  <p class="tarif-speed">300 Мбит/с</p>
                  <div
            ...
            <div class="swiper-slide tarif-option">
              <div class="tarif-slider-description">
                ...
                <p class="tarif-price">
                  777 <span style="font-size: 0.75rem">₽/мес</span>
                </p>
                <div class="tarif-param">
